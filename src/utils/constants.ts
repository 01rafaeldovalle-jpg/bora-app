...
export const MOCK_PLACES: Place[] = [
  {
    ...
    description_en: 'One of the main postcards of the city. It features an iconic greenhouse inspired by London\'s Crystal Palace, geometric gardens, and the Botanical Museum.',
    description_es: 'Una de las principales postales de la ciudad. Cuenta con un invernadero icónico inspirado en el Crystal Palace de Londres, jardines geométricos y el Museo Botánico.',
  ...
  },
  {
    ...
    description_en: 'Tubular theater built with steel structure and polycarbonate roof, integrated into a natural landscape of an inactive quarry, lakes and waterfall.',
    description_es: 'Teatro tubular construido con estructura de acero y techo de policarbonato, integrado a un paisaje natural de cantera inactiva, lagos y cascada.',
  ...
  },
  {
    ...
    description_en: 'The largest and most visited park in Curitiba. It features running tracks, barbecue grills, huge lakes, and the city\'s famous resident capybaras.',
    description_es: 'El parque más grande y visitado de Curitiba. Cuenta con pistas de atletismo, parrillas, lagos inmensos y las famosas capibaras residentes de la ciudad.',
  ...
  },
  {
    ...
    description_en: 'Traditional German tavern in the heart of the Historic Center. Famous for its Submarino draft beer and the gigantic Eisbein (pork knuckle).',
    description_es: 'Taberna tradicional alemana en el corazón del Centro Histórico. Famosa por el chopp Submarino y el gigantesco Eisbein (codillo de cerdo).',
  ...
  },
  {
    ...
    description_en: 'Panoramic restaurant on top of the Champagnat Building. It offers fine Italian and Uruguayan cuisine with a spectacular 360-degree view of Curitiba.',
    description_es: 'Restaurante panorámico en la cima del Edificio Champagnat. Ofrece alta cocina italiana y uruguaya con una espectacular vista de 360 grados de Curitiba.',
  ...
  },
  {
    ...
    description_en: 'One of the most awarded coffee shops in Brazil, a pioneer in specialty coffees from micro-lots roasted on-site and accompanied by excellent pastries.',
    description_es: 'Una de las cafeterías más galardonadas de Brasil, pionera en cafés especiales de micro-lotes tostados en el lugar y acompañados de una excelente pastelería.',
  ...
  },
  {
    ...
    description_en: 'Better known as the "Eye Museum". It houses incredible exhibitions of visual arts, design, and architecture in an iconic futuristic structure.',
    description_es: 'Más conocido como el "Museo del Ojo". Alberga increíbles exposiciones de artes visuales, diseño y arquitectura en una estructura futurista icónica.',
