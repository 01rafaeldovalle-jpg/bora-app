...
export const TRANSLATIONS = {
  pt: {
    ...
    sua_foto: "Sua foto",
    escolha_avatar: "Escolha um avatar para seu perfil (opcional)",
    tirar_foto: "Tirar Foto",
    galeria: "Galeria",
    seus_interesses: "Seus interesses",
    escolha_tres: "Escolha pelo menos 3 para calibrar seu Swipe ⚡",
    minimo: "mínimo",
    ativar_localizacao: "Ativar Localização",
    gps_desc: "O Giro usa sua localização para recomendar os melhores lugares perto de você em tempo real.",
    ativar_gps: "Ativar GPS (Recomendado)",
    sem_gps: "Continuar sem GPS",
    criando_conta: "Criando sua conta...",
    ...
    editar: "Editar",
    nenhuma_preferencia: "Nenhuma preferência.",
    adicionar: "[+ Adicionar]",
    dados_cadastrais: "Dados Cadastrais",
    gerenciar_notificacoes: "Gerenciar Notificações",
    excluir_conta_definitiva: "Excluir Conta Definitivamente",
    ...
    // Prefs
    pref_pet: "🐶 Pet Friendly",
    pref_vegan: "🌿 Vegano / Saudável",
    pref_work: "💻 Trabalhar",
    pref_outdoor: "☀️ Ao Ar Livre",
    pref_live_music: "🎶 Música ao Vivo",
    pref_date: "🕯️ Encontro",
    pref_cheap: "💰 Econômico",
    pref_sofisticado: "💎 Sofisticado",
    pref_descontraido: "🍻 Descontraído",
    pref_kids: "🧒 Espaço Kids",
    pref_lgbt: "🌈 LGBTQ+ Friendly",
    pref_acc_motor: "♿ Acessibilidade Motora",
    ...
    sobre_voce_desc: "Queremos deixar sua experiência a sua cara! Conta pra gente um pouco mais sobre você.",
    data_nascimento: "Data de Nascimento",
    genero: "Gênero",
    genero_select: "Selecione seu gênero...",
    genero_f: "Feminino",
    genero_m: "Masculino",
    genero_nb: "Não-binário",
    genero_outro: "Outro",
    genero_pnd: "Prefiro não dizer",
    genero_descreva: "Como você se descreve? (Opcional)",
    genero_descreva_placeholder: "Ex: Transgênero, Gênero Fluido, Agênero",
    pronomes: "Pronomes (Exibido no perfil)",
    pronomes_select: "Selecione seus pronomes...",
    pronomes_ela_dela: "Ela / Dela",
    pronomes_ele_dele: "Ele / Dele",
    pronomes_elu_delu: "Elu / Delu (Neutro)",
    pronomes_pnd: "Prefiro não exibir pronomes",
    avancar: "Avançar"
  },
  en: {
    // Navegação Inferior
    ...
    termos_uso: "Terms of Use & Privacy Policy",
    li_aceito: "I read and accept the",
    continuar: "Continue",
    ...
    sua_foto: "Your photo",
    escolha_avatar: "Choose an avatar for your profile (optional)",
    tirar_foto: "Take Photo",
    galeria: "Gallery",
    seus_interesses: "Your interests",
    escolha_tres: "Choose at least 3 to calibrate your Swipe ⚡",
    minimo: "minimum",
    ativar_localizacao: "Enable Location",
    gps_desc: "Giro uses your location to recommend the best places near you in real time.",
    ativar_gps: "Enable GPS (Recommended)",
    sem_gps: "Continue without GPS",
    criando_conta: "Creating your account...",
    ...
    selo_bronze: "Bronze",
    ativo: "active",
    ciclar_selos: "Click to cycle badges • Activity level",
    salvos: "SAVED",
    reviews: "REVIEWS",
    ajudou: "HELPED",
    minhas_preferencias: "My Preferences",
    editar: "Edit",
    nenhuma_preferencia: "No preferences.",
    adicionar: "[+ Add]",
    dados_cadastrais: "Account Details",
    gerenciar_notificacoes: "Manage Notifications",
    excluir_conta_definitiva: "Delete Account Permanently",
    sair_conta: "Sign Out",
    ...
    // Prefs
    pref_pet: "🐶 Pet Friendly",
    pref_vegan: "🌿 Vegan / Healthy",
    pref_work: "💻 Coworking Friendly",
    pref_outdoor: "☀️ Outdoor Seating",
    pref_live_music: "🎶 Live Music",
    pref_date: "🕯️ Romantic Spot",
    pref_cheap: "💰 Budget Friendly",
    pref_sofisticado: "💎 Premium / Upscale",
    pref_descontraido: "🍻 Casual / Chill",
    pref_kids: "🧒 Kid Friendly",
    pref_lgbt: "🌈 LGBTQ+ Friendly",
    pref_acc_motor: "♿ Wheelchair Accessible",
    ...
    sobre_voce_desc: "We want to make your experience just like you! Tell us a little more about yourself.",
    data_nascimento: "Date of Birth",
    genero: "Gender",
    genero_select: "Select your gender...",
    genero_f: "Female",
    genero_m: "Male",
    genero_nb: "Non-binary",
    genero_outro: "Other",
    genero_pnd: "Prefer not to say",
    genero_descreva: "How do you describe yourself? (Optional)",
    genero_descreva_placeholder: "e.g., Transgender, Genderfluid, Agender",
    pronomes: "Pronouns (Shown on profile)",
    pronomes_select: "Select your pronouns...",
    pronomes_ela_dela: "She / Her",
    pronomes_ele_dele: "He / Him",
    pronomes_elu_delu: "They / Them (Neutral)",
    pronomes_pnd: "Prefer not to display pronouns",
    avancar: "Next"
  },
  es: {
    // Navegação Inferior
    ...
    terms_footer: "Al ingresar, aceptas nuestros Términos y Privacidad",
    ...
    termos_uso: "Términos de Uso y Política de Privacidad",
    li_aceito: "Leí y acepto los",
    continuar: "Continuar",
    ...
    sua_foto: "Tu foto",
    escolha_avatar: "Elige un avatar para tu perfil (opcional)",
    tirar_foto: "Tomar Foto",
    galeria: "Galería",
    seus_interesses: "Tus intereses",
    escolha_tres: "Elige al menos 3 para calibrar tu Swipe ⚡",
    minimo: "mínimo",
    ativar_localizacao: "Activar Localización",
    gps_desc: "Giro usa tu ubicación para recomendar los mejores lugares cerca de ti en tiempo real.",
    ativar_gps: "Activar GPS (Recomendado)",
    sem_gps: "Continuar sin GPS",
    criando_conta: "Creando tu cuenta...",
    ...
    editar: "Editar",
    nenhuma_preferencia: "Ninguna preferencia.",
    adicionar: "[+ Añadir]",
    dados_cadastrais: "Datos de la Cuenta",
    gerenciar_notificacoes: "Gestionar Notificaciones",
    excluir_conta_definitiva: "Eliminar Cuenta Definitivamente",
    ...
    // Prefs
    pref_pet: "🐶 Pet Friendly",
    pref_vegan: "🌿 Vegano / Saludable",
    pref_work: "💻 Apto para Trabajar",
    pref_outdoor: "☀️ Al Aire Libre",
    pref_live_music: "🎶 Música en Vivo",
    pref_date: "🕯️ Cita Romántica",
    pref_cheap: "💰 Económico",
    pref_sofisticado: "💎 Sofisticado / Premium",
    pref_descontraido: "🍻 Descontracturado / Casual",
    pref_kids: "🧒 Espacio Kids",
    pref_lgbt: "🌈 LGBTQ+ Friendly",
    pref_acc_motor: "♿ Accesibilidad Motora",
    ...
    sobre_voce: "Sobre ti",
    sobre_voce_desc: "¡Queremos hacer tu experiencia a tu medida! Cuéntanos un poco más sobre ti.",
    data_nascimento: "Fecha de Nacimiento",
    genero: "Género",
    genero_select: "Seleccione su género...",
    genero_f: "Femenino",
    genero_m: "Masculino",
    genero_nb: "No binario",
    genero_outro: "Otro",
    genero_pnd: "Prefiero no decir",
    genero_descreva: "Como te describes? (Opcional)",
    genero_descreva_placeholder: "Ej: Transgênero, Género fluido, Agénero",
    pronomes: "Pronombres (Se muestra en el perfil)",
    pronomes_select: "Seleccione sus pronombres...",
    pronomes_ela_dela: "Ella / Dela",
    pronomes_ele_dele: "Él / Dele",
    pronomes_elu_delu: "Elu / Delu (Neutro)",
    pronomes_pnd: "Prefiero no mostrar pronombres",
    avancar: "Avanzar"
  },
};
